    ...
    public partial class Form29 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                connection.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\LAPTOP SELLS AND SERVICES FINAL PROJECT\Laptop sales & sevices\Mouse_bill.accdb;Persist Security Info=True";
                connection.Open();
                OleDbCommand command1 = new OleDbCommand();
                command1.Connection = connection;
                command1.CommandText = "INSERT INTO bill(Customer_name,Mob_no,Mouse_name,Unit_price,Quantity,Bill) Values('" + textBox8.Text + "' ,'" + textBox9.Text + "','" + textBox1.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "')";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text += "Mob no:    " + textBox9.Text + "\n\n";
            richTextBox1.Text += "\n";
            richTextBox1.Text += "DATE" + DateTime.Now + "\n\n";
            richTextBox1.Text += "\n";
            richTextBox1.Text += "Mouse Name:   " + textBox1.Text + "\n\n";
